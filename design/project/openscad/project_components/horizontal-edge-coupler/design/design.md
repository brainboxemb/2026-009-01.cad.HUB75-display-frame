...
![Profile Raw Cross](img/04-profile-raw-cross.png)
...
![Profile Rounded Cross](img/05-profile-rounded-cross.png)
...
![Profile T](img/06-profile-t.png)
...
![Reinforcement Support Profile](img/07-reinforcement-support-profile.png)
...
![Screw Holes](img/08-screw-holes.png)
...
![Tube Pockets](img/09-tube-pockets.png)
...
![Locator Pin Clearance](img/10-locator-pin-clearance.png)
...
![Guide Keepout](img/11-guide-keepout.png)
...
![Guide Raw Shell](img/12-guide-raw-shell.png)
...
![Guide Rounded Shell](img/13-guide-rounded-shell.png)
...
![Guide Zones](img/14-guide-zones.png)
...
![Guide Outer Taper](img/15-guide-outer-taper.png)
...
![Horizontal-edge supported guide and reinforcement relief construction](img/16-guide-reinforcement-reliefs.png)
...
![Horizontal-edge HUB75 reinforcement and supported guide clearance detail](img/17-guide-reinforcement-detail.png)
...
![Reinforcement Locators](img/19-reinforcement-locators.png)
...
![Seam Locator](img/20-seam-locator.png)
...
![Functional](img/21-functional.png)
...
![Reference Pockets](img/22-reference-pockets.png)
...
![Center Marks](img/23-center-marks.png)
