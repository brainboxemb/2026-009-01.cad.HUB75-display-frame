...
Rationale is in [30-00-specification.md](30-00-specification.md), architecture in
[40-00-design.md](40-00-design.md), and verification in [50-00-verification.md](50-00-verification.md).
...
| Why the project exists | [30-00-specification.md](30-00-specification.md) |
| Application architecture/ownership | [40-00-design.md](40-00-design.md) |
| Detailed component construction | component-local `design/design.md` |
| Verification/current acceptance | [50-00-verification.md](50-00-verification.md) |
...
Migration 011 issue #61 is the current repository-infrastructure rollout. It
adopts the accepted tool/library baselines, managed root launchers, current
self/reusable workflow naming and the shared numbered documentation structure
without changing core-coupler, tube-mount/dovetail, reinforcement or physical
