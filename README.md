...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 10.979 s |
| Cache restore | 1.490 s |
| Runtime pull | 12.389 s |
| Capability materialization | 58.878 s |
| Cache save | 1.565 s |
| Validation + finishing | 680 ms |
| Snapshot preparation | 41 ms |
| **Total to prepared snapshot** | **86.098 s** |
