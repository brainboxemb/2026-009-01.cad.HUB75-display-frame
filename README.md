...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 9.082 s |
| Cache restore | 1.794 s |
| Runtime pull | 13.094 s |
| Capability materialization | 59.377 s |
| Cache save | 3.077 s |
| Validation + finishing | 805 ms |
| Snapshot preparation | 78 ms |
| **Total to prepared snapshot** | **87.384 s** |
