...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 10.465 s |
| Cache restore | 2.907 s |
| Runtime pull | 14.768 s |
| Capability materialization | 11.132 s |
| Cache save | 1.969 s |
| Validation + finishing | 199 ms |
| Snapshot preparation | 4 ms |
| **Total to prepared snapshot** | **41.492 s** |
