...
module _hub75_corner_edge_design_horizontal_arm_2d(coupler_obj) {
...
module _hub75_corner_edge_design_vertical_arm_2d(coupler_obj) {
    reach = hub75_corner_edge_coupler_inward_reach(coupler_obj);
    z_min = -reach;
...
module _hub75_corner_edge_design_raw_cross_2d(coupler_obj) {
    union() {
        _hub75_corner_edge_design_horizontal_arm_2d(coupler_obj);
        _hub75_corner_edge_design_vertical_arm_2d(coupler_obj);
    }
}

module _hub75_corner_edge_design_end_rail_2d(coupler_obj) {
    reach = hub75_corner_edge_coupler_inward_reach(coupler_obj);
    x_min = coupler_obj.side == "left" ? -coupler_obj.outside_projection : -reach;
    x_max = coupler_obj.side == "left" ? reach : coupler_obj.outside_projection;
    translate([
        ...
        square([x_max - x_min + 6, coupler_obj.rear_end_rail_width], center = true);
}

module _hub75_corner_edge_design_profile_window_2d(coupler_obj) {
    reach = hub75_corner_edge_coupler_inward_reach(coupler_obj);
    x_min = coupler_obj.side == "left" ? -coupler_obj.outside_projection : -reach;
    x_max = coupler_obj.side == "left" ? reach : coupler_obj.outside_projection;
    z_min = -reach;
...
module _hub75_corner_edge_design_panel_keepout_visible_2d(coupler_obj) {
    intersection() {
        _hub75_corner_edge_coupler_panel_keepout_2d(coupler_obj);
        _hub75_corner_edge_design_profile_window_2d(coupler_obj);
    }
}

module _hub75_corner_edge_design_clearance_band_2d(coupler_obj) {
    difference() {
        intersection() {
        ...
        _hub75_corner_edge_design_panel_keepout_visible_2d(coupler_obj);
    }
}

module _hub75_corner_edge_design_profile_outline_2d(coupler_obj, line_width = 1.0) {
    difference() {
...
module _hub75_corner_edge_design_raw_guide_shell_2d(coupler_obj) {
    difference() {
...
module _hub75_corner_edge_design_straight_outer_ridges(coupler_obj) {
    _hub75_corner_edge_coupler_extrude_xz_y(-coupler_obj.guide_height, 0)
        _hub75_corner_edge_design_outer_ridges_2d(coupler_obj);
}

module _hub75_corner_edge_design_reinforcement_relief_cutter(coupler_obj) {
    eps = 0.05;
...
module _hub75_corner_edge_design_reinforcement_guide_fragment(coupler_obj, position) {
    intersection() {
        _hub75_corner_edge_design_unrelieved_tall_guide(coupler_obj);
        _hub75_corner_edge_design_reinforcement_crop(coupler_obj, position);
    }
}

module _hub75_corner_edge_design_reinforcement_clearance_band(coupler_obj, position) {
    outer_d =
    ...
    translate([position[0], 0, position[1]])
        difference() {
            _hub75_corner_edge_coupler_extrude_xz_y(-coupler_obj.guide_height, 0)
                circle(d = outer_d);
            _hub75_corner_edge_coupler_extrude_xz_y(-coupler_obj.guide_height - 0.05, 0.05)
                circle(d = inner_d);
        }
}

module _hub75_corner_edge_design_reinforcement_collision(coupler_obj, position) {
    intersection() {
        _hub75_corner_edge_design_reinforcement_guide_fragment(coupler_obj, position);
        _hub75_corner_edge_design_reinforcement_relief_cutter(coupler_obj);
    }
}
...
module _hub75_corner_edge_design_after_reference_pockets(coupler_obj) {
    union() {
        difference() {
